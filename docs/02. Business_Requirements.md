...
- **Validation**:
  ...
  - Password bắt buộc, theo cấu hình password policy của hệ thống
...
- Validate độ mạnh mật khẩu theo cấu hình password policy của hệ thống

#### 3.1.2. Quản lý Người dùng

**FR-USER-001**: Tạo người dùng mới

- **Thông tin bắt buộc**: Họ tên, Email, Vai trò
...
- Người dùng tự cập nhật thông tin cá nhân (trừ username, vai trò, email và trạng thái)
...
- **Quyền hạn**: Xem, Tạo, Sửa, Xóa theo vai trò và theo từng service/module
...
- **NFR-SEC-006**: RBAC (Role-Based Access Control) per module
...
- **NFR-SCALE-001**: Kiến trúc microservices
