...
import { AssetStatus, AssetType, AssetCreateRequest, AssetUpdateRequest } from "@/types/asset";
...
const assetFormSchema = z.object({
  ...
  year_of_manufacture: z.number().min(1900).max(new Date().getFullYear()).optional(),
          ...
          <div className="container mx-auto px-4 py-6">
            <div>
              ...
              <p className="text-muted-foreground">
                {isEditMode ? "Update asset information" : "Fill in the asset details"}
              </p>
            </div>
        </div>
      </div>
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        >
                          ...
                          <SelectContent>
                            <SelectItem value={AssetStatus.NEW}>New</SelectItem>
