...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_auth_db_roles_name"), "roles", ["name"], unique=True, schema="auth_db"
    )
    ...
    op.create_index(
        op.f("ix_auth_db_permissions_name"),
        "permissions",
        ["name"],
        unique=True,
        schema="auth_db",
    ...
    op.create_index(
        op.f("ix_auth_db_permissions_resource"),
        "permissions",
        ["resource"],
        schema="auth_db",
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "user_type", sa.String(length=20), nullable=False, server_default="local"
        ),
    ...
    op.create_index(
        op.f("ix_auth_db_users_username"),
        "users",
        ["username"],
        unique=True,
        schema="auth_db",
    ...
    op.create_index(
        op.f("ix_auth_db_users_ad_sync_id"), "users", ["ad_sync_id"], schema="auth_db"
    )
    ...
    op.create_index(
        op.f("ix_auth_db_refresh_tokens_token"),
        "refresh_tokens",
        ["token"],
        unique=True,
        schema="auth_db",
    ...
    op.create_index(
        op.f("ix_auth_db_refresh_tokens_user_id"),
        "refresh_tokens",
        ["user_id"],
        schema="auth_db",
    )
    ...
    op.create_index(
        op.f("ix_auth_db_password_reset_tokens_token"),
        "password_reset_tokens",
        ["token"],
        unique=True,
        schema="auth_db",
    ...
    op.create_index(
        op.f("ix_auth_db_password_reset_tokens_user_id"),
        "password_reset_tokens",
        ["user_id"],
        schema="auth_db",
    )
    ...
    op.create_index(
        op.f("ix_auth_db_mfa_backup_codes_user_id"),
        "mfa_backup_codes",
        ["user_id"],
        schema="auth_db",
    )
