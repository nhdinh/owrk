...
def upgrade():
    ...
    op.create_index(
        "ix_auth_db_user_history_user_id",
        "user_history",
        ["user_id"],
        unique=False,
        schema="auth_db",
    ...
    op.create_index(
        "ix_auth_db_role_history_role_id",
        "role_history",
        ["role_id"],
        unique=False,
        schema="auth_db",
...
def downgrade():
    # Drop indexes
    op.drop_index(
        "ix_auth_db_role_history_role_id", table_name="role_history", schema="auth_db"
    )
    op.drop_index(
        "ix_auth_db_user_history_user_id", table_name="user_history", schema="auth_db"
    )
