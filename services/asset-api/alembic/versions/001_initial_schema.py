...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["parent_id"],
            ["asset_db.asset_categories.id"],
            name="fk_asset_categories_parent",
        ),
    ...
    op.create_index(
        "idx_asset_categories_code", "asset_categories", ["code"], schema="asset_db"
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "asset_type",
            sa.Enum("FIXED_ASSET", "TOOL", name="assettype"),
            nullable=False,
        ),
        sa.Column("description", sa.Text(), nullable=True),
        ...
        sa.ForeignKeyConstraint(
            ["category_id"], ["asset_db.asset_categories.id"], name="fk_assets_category"
        ),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_index(
        "idx_assets_asset_code", "assets", ["asset_code"], schema="asset_db"
    )
    op.create_index(
        "idx_assets_category_id", "assets", ["category_id"], schema="asset_db"
    )
    op.create_index("idx_assets_status", "assets", ["status"], schema="asset_db")
    op.create_index(
        "idx_assets_asset_type", "assets", ["asset_type"], schema="asset_db"
    )
    op.create_index(
        "idx_assets_department_id", "assets", ["department_id"], schema="asset_db"
    )
    op.create_index(
        "idx_assets_current_user_id", "assets", ["current_user_id"], schema="asset_db"
    )
    op.create_index(
        "idx_assets_purchase_date", "assets", ["purchase_date"], schema="asset_db"
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "return_condition",
            sa.Enum("GOOD", "DAMAGED", "BROKEN", name="returncondition"),
            nullable=True,
        ),
        sa.Column("return_notes", sa.Text(), nullable=True),
        sa.Column(
            "status",
            sa.Enum("ACTIVE", "RETURNED", name="assignmentstatus"),
            nullable=False,
    ...
    op.create_index(
        "idx_asset_assignments_asset_id",
        "asset_assignments",
        ["asset_id"],
        schema="asset_db",
    )
    op.create_index(
        "idx_asset_assignments_user_id",
        "asset_assignments",
        ["user_id"],
        schema="asset_db",
    )
    op.create_index(
        "idx_asset_assignments_status",
        "asset_assignments",
        ["status"],
        schema="asset_db",
    )
    op.create_index(
        "idx_asset_assignments_assigned_date",
        "asset_assignments",
        ["assigned_date"],
        schema="asset_db",
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "file_type",
            sa.Enum("INVOICE", "WARRANTY", "PHOTO", "DOCUMENT", name="filetype"),
            nullable=False,
        ),
    ...
    op.create_index(
        "idx_asset_attachments_asset_id",
        "asset_attachments",
        ["asset_id"],
        schema="asset_db",
    )
    op.create_index(
        "idx_asset_attachments_file_type",
        "asset_attachments",
        ["file_type"],
        schema="asset_db",
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "depreciation_amount", sa.Numeric(precision=15, scale=2), nullable=False
        ),
        ...
        sa.ForeignKeyConstraint(
            ["asset_id"],
            ["asset_db.assets.id"],
            name="fk_asset_depreciation_asset",
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_index(
        "idx_asset_depreciation_asset_id",
        "asset_depreciation_records",
        ["asset_id"],
        schema="asset_db",
    )
