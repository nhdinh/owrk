...
class Asset(BaseModel):
    ...
    category_id = Column(
        String(36), ForeignKey("asset_db.asset_categories.id"), nullable=False, index=True
    )
    ...
    purchase_order_id = Column(String(36), nullable=True)  # Link to procurement service (UUID)
    ...
    department_id = Column(String(36), nullable=True, index=True)  # UUID reference
    ...
    # Audit
    created_by = Column(String(36), nullable=False)  # User UUID
