...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("ACTIVE", "INACTIVE", "BLACKLISTED", name="vendorstatus"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_procurement_db_vendors_id"),
        "vendors",
        ["id"],
        unique=False,
        schema="procurement_db",
    ...
    op.create_index(
        op.f("ix_procurement_db_vendors_vendor_code"),
        "vendors",
        ["vendor_code"],
        unique=False,
        schema="procurement_db",
    ...
    op.create_table(
        ...
        sa.Column(
            "contract_value", mysql.DECIMAL(precision=15, scale=2), nullable=False
        ),
        ...
        sa.Column(
            "status",
            sa.Enum("ACTIVE", "EXPIRED", "TERMINATED", name="contractstatus"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_procurement_db_framework_contracts_id"),
        "framework_contracts",
        ["id"],
        unique=False,
        schema="procurement_db",
    ...
    op.create_index(
        op.f("ix_procurement_db_framework_contracts_contract_code"),
        "framework_contracts",
        ["contract_code"],
        unique=False,
        schema="procurement_db",
    ...
    op.create_table(
        ...
        sa.Column(
            "procurement_type",
            sa.Enum("GOODS", "SERVICES", "BOTH", name="procurementtype"),
            nullable=False,
        ),
        sa.Column("justification", sa.Text(), nullable=True),
        sa.Column("budget_code", sa.String(length=50), nullable=True),
        sa.Column(
            "estimated_total", mysql.DECIMAL(precision=15, scale=2), nullable=True
        ),
        sa.Column(
            "approval_status",
            sa.Enum(
    ...
    op.create_index(
        op.f("ix_procurement_db_purchase_requests_id"),
        "purchase_requests",
        ["id"],
        unique=False,
        schema="procurement_db",
    ...
    op.create_index(
        op.f("ix_procurement_db_purchase_requests_request_code"),
        "purchase_requests",
        ["request_code"],
        unique=False,
        schema="procurement_db",
    ...
    op.create_index(
        op.f("ix_procurement_db_purchase_requests_approval_status"),
        "purchase_requests",
        ["approval_status"],
        unique=False,
        schema="procurement_db",
    ...
    op.create_table(
        ...
        sa.Column(
            "estimated_unit_price", mysql.DECIMAL(precision=15, scale=2), nullable=True
        ),
        sa.Column(
            "estimated_total_price", mysql.DECIMAL(precision=15, scale=2), nullable=True
        ),
        sa.Column("notes", sa.Text(), nullable=True),
        sa.Column(
            "created_at",
        ...
        sa.ForeignKeyConstraint(
            ["purchase_request_id"],
            ["procurement_db.purchase_requests.id"],
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id"),
        schema="procurement_db",
    ...
    op.create_index(
        op.f("ix_procurement_db_purchase_request_items_id"),
        "purchase_request_items",
        ["id"],
        unique=False,
        schema="procurement_db",
    ...
    op.create_index(
        op.f("ix_procurement_db_purchase_request_items_purchase_request_id"),
        "purchase_request_items",
        ["purchase_request_id"],
        unique=False,
        schema="procurement_db",
    ...
    op.create_table(
        ...
        sa.Column(
            "discount_amount", mysql.DECIMAL(precision=15, scale=2), nullable=True
        ),
        ...
        sa.Column(
            "status",
            sa.Enum("PENDING", "APPROVED", "REJECTED", name="quotationstatus"),
            nullable=False,
        ),
        sa.Column("notes", sa.Text(), nullable=True),
        sa.Column("created_by", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_procurement_db_quotations_id"),
        "quotations",
        ["id"],
        unique=False,
        schema="procurement_db",
    ...
    op.create_index(
        op.f("ix_procurement_db_quotations_quotation_code"),
        "quotations",
        ["quotation_code"],
        unique=False,
        schema="procurement_db",
    ...
    op.create_index(
        op.f("ix_procurement_db_quotations_vendor_id"),
        "quotations",
        ["vendor_id"],
        unique=False,
        schema="procurement_db",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["quotation_id"], ["procurement_db.quotations.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["purchase_request_item_id"],
            ["procurement_db.purchase_request_items.id"],
            ondelete="SET NULL",
        ),
        sa.PrimaryKeyConstraint("id"),
        schema="procurement_db",
    ...
    op.create_index(
        op.f("ix_procurement_db_quotation_items_id"),
        "quotation_items",
        ["id"],
        unique=False,
        schema="procurement_db",
    ...
    op.create_index(
        op.f("ix_procurement_db_quotation_items_quotation_id"),
        "quotation_items",
        ["quotation_id"],
        unique=False,
        schema="procurement_db",
    ...
    op.create_index(
        op.f("ix_procurement_db_purchase_orders_id"),
        "purchase_orders",
        ["id"],
        unique=False,
        schema="procurement_db",
    ...
    op.create_index(
        op.f("ix_procurement_db_purchase_orders_order_code"),
        "purchase_orders",
        ["order_code"],
        unique=False,
        schema="procurement_db",
    ...
    op.create_index(
        op.f("ix_procurement_db_purchase_orders_order_date"),
        "purchase_orders",
        ["order_date"],
        unique=False,
        schema="procurement_db",
    ...
    op.create_index(
        op.f("ix_procurement_db_purchase_orders_status"),
        "purchase_orders",
        ["status"],
        unique=False,
        schema="procurement_db",
    ...
    op.create_index(
        op.f("ix_procurement_db_purchase_orders_vendor_id"),
        "purchase_orders",
        ["vendor_id"],
        unique=False,
        schema="procurement_db",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["purchase_order_id"],
            ["procurement_db.purchase_orders.id"],
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["quotation_item_id"],
            ["procurement_db.quotation_items.id"],
            ondelete="SET NULL",
        ),
        sa.PrimaryKeyConstraint("id"),
        schema="procurement_db",
    ...
    op.create_index(
        op.f("ix_procurement_db_purchase_order_items_id"),
        "purchase_order_items",
        ["id"],
        unique=False,
        schema="procurement_db",
    ...
    op.create_index(
        op.f("ix_procurement_db_purchase_order_items_purchase_order_id"),
        "purchase_order_items",
        ["purchase_order_id"],
        unique=False,
        schema="procurement_db",
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_procurement_db_framework_contracts_contract_code"),
        table_name="framework_contracts",
        schema="procurement_db",
    )
    op.drop_index(
        op.f("ix_procurement_db_framework_contracts_id"),
