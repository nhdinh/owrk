...
class VendorBase(BaseModel):
    ...
    company_name: str = Field(..., min_length=1, max_length=255, description="Vendor company name")
    ...
    business_registration: Optional[str] = Field(None, max_length=50, description="Business registration number")
...
class VendorBlacklistRequest(BaseModel):
    ...
    reason: str = Field(..., min_length=10, description="Reason for blacklisting (min 10 characters)")
