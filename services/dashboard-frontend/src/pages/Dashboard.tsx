...
import { Users, Package, Activity, Shield, TrendingUp, AlertCircle, CheckCircle, XCircle } from 'lucide-react';
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {health?.services.map((service) => (
              <Card key={service.service}>
                ...
                <CardContent>
                  <div className={`text-2xl font-bold ${getStatusColor(service.status)}`}>
