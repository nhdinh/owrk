...
### Authentication
- Shares authentication with auth-frontend-v2
...
# Docker
docker compose build asset-fe-v2       # Build image
docker compose up -d asset-fe-v2       # Start container
docker compose logs -f asset-fe-v2     # View logs
docker compose stop asset-fe-v2        # Stop container
docker compose restart asset-fe-v2     # Restart container
```
...
4. **Monitor logs**:
   ```bash
   docker compose logs -f asset-fe-v2
   ```
...
**Port**: 3200
**Repository**: services/asset-frontend-v2
